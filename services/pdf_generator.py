...
class PDFGenerator:
    ...
    def _render_template(self, template: str, data: Dict[str, Any]) -> str:
        ...
        replacements = {
            ...
            '{{NORTH_STAR_NAME}}': html.escape(str(metrics.get('north_star_metric', {}).get('nome', 'N/A'))),
            '{{NORTH_STAR_DESC}}': html.escape(str(metrics.get('north_star_metric', {}).get('descricao', ''))),
            '{{NORTH_STAR_JUST}}': html.escape(str(metrics.get('north_star_metric', {}).get('justificativa', ''))),
            '{{KPIS_LIST}}': kpis_html,
            '{{OKRS_LIST}}': okrs_html,
